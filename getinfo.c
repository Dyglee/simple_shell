...
/**
 * clear_info - Initializes the info_t struct by setting its fields to NULL.
...
/**
 * set_info - Initializes the info_t struct with provided data.
 * @info: Pointer to the info_t struct to be initialized.
...
/**
 * free_info - Frees memory associated with the info_t struct fields.
